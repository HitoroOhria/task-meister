...
describe("recursivelyUpdateGroupWidth", () => {
  ...
  test("GroupWidth is set to sum of itself and longest among children when there are one or more children", () => {
    ...
    nodeData1.children.list[0].nodeWidth = 200;
    ...
    nodeData2.children.list[0].nodeWidth = 200;
    nodeData2.children.list[1].nodeWidth = 300;
    nodeData2.children.list[2].nodeWidth = 400;
  ...
  test("GroupWidth is set to recursive sum of children when children are nested", () => {
    ...
    nodeData.children.list[0].nodeWidth = 200;
    nodeData.children.list[0].children.list.push(
    ...
    nodeData.children.list[0].children.list[0].nodeWidth = 400;
    nodeData.children.list[0].children.list[1].nodeWidth = 500;

    // As result of recursivelyUpdateGroupWidth, groupWidth of second child is 10000
    nodeData.children.list.push(
      newNodeData("child2", "", newGroup(), newChildren([]))
    );
    nodeData.children.list[1].nodeWidth = 300;
    nodeData.children.list[1].children.list.push(
    ...
    nodeData.children.list[1].children.list[0].nodeWidth = 600;
    nodeData.children.list[1].children.list[1].nodeWidth = 700;
...
describe("recursivelyUpdateGroupHeight", () => {
  ...
  test("GroupHeight is set to height of node or children when there are one or more children", () => {
    ...
    nodeData1.children.list[0].nodeHeight = 300;
  ...
  test("GroupHeight is set to height of node or children when children is nested", () => {
    ...
    nodeData.children.list[0].nodeHeight = 400;
    nodeData.children.list[0].children.height = 400;

    nodeData.children.list[0].children.list.push(
      newNodeData("child1 of child1", "", newGroup(), newChildren([]))
    );
    nodeData.children.list[0].children.list[0].nodeHeight = 150;
    nodeData.children.list[0].children.list[0].children.height = 0;

    nodeData.children.list[0].children.list.push(
      newNodeData("child2 of child1", "", newGroup(), newChildren([]))
    );
    nodeData.children.list[0].children.list[1].nodeHeight = 250;
    ...
    nodeData.children.list[1].nodeHeight = 300;
    nodeData.children.list[1].children.height = 1300;

    nodeData.children.list[1].children.list.push(
      newNodeData("child1 of child2", "", newGroup(), newChildren([]))
    );
    nodeData.children.list[1].children.list[0].nodeHeight = 600;
    nodeData.children.list[1].children.list[0].children.height = 0;

    nodeData.children.list[1].children.list.push(
      newNodeData("child2 of child2", "", newGroup(), newChildren([]))
    );
    nodeData.children.list[1].children.list[1].nodeHeight = 700;
...
describe("recursivelyUpdateChildrenNodeTop", () => {
  ...
  test("NodeTop of children should be updated when there are one or more children", () => {
    ...
    // why -100?
    expect(nodeData1.children.list[0].nodeTop).toBe(-50);
    ...
    expect(nodeData2.children.list[0].nodeTop).toBe(-600);
    expect(nodeData2.children.list[1].nodeTop).toBe(-400);
    expect(nodeData2.children.list[2].nodeTop).toBe(-300);
  });
  ...
  test("NodeTop of children should be updated when children is nested", () => {
    ...
    nodeData.children.list[0].nodeHeight = 450;
    ...
    nodeData.children.list[0].children.list[0].nodeHeight = 200;
    ...
    nodeData.children.list[0].children.list[1].nodeHeight = 50;
    ...
    nodeData.children.list[1].nodeHeight = 600;
    ...
    nodeData.children.list[1].children.list[0].nodeHeight = 1000;
    ...
    nodeData.children.list[1].children.list[1].nodeHeight = 450;
    ...
    expect(nodeData.children.list[0].nodeTop).toBe(-600);
    expect(nodeData.children.list[0].children.list[0].nodeTop).toBe(-500);
    expect(nodeData.children.list[0].children.list[1].nodeTop).toBe(-300);
    expect(nodeData.children.list[1].nodeTop).toBe(-150);
    expect(nodeData.children.list[1].children.list[0].nodeTop).toBe(-250);
    expect(nodeData.children.list[1].children.list[1].nodeTop).toBe(750);
  });
});
